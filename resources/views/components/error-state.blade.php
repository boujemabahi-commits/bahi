@php
    ...
    $description = $description ?? 'تعذر تحميل البيانات. يرجى إعادة المحاولة.';
@endphp
<div class="flex flex-col items-center justify-center text-center py-14 px-6">
    ...
    <button type="button" class="btn-secondary mt-4" data-toast="تمت إعادة المحاولة" onclick="location.reload()">
