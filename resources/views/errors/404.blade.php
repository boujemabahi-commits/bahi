...
<div class="flex flex-col items-center justify-center text-center py-24 px-6">
    ...
    <h1 class="text-xl font-bold text-ink-800 mb-2">{{ __('الصفحة غير موجودة') }}</h1>
    <p class="text-sm text-ink-500 max-w-sm mb-6">{{ __('الصفحة التي تحاول الوصول إليها غير موجودة أو تم نقلها.') }}</p>
